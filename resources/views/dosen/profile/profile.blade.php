...
<div class="container-fluid mt-5">
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="card">
                <div class="card-body">
                    <h3 class="card-title">Profile Dosen</h3>
                    <form action="/updateprofile/dosen" method="POST">
                        @csrf
                        @method('POST')
                        <div class="form-body">
                            <div class="">
                            ...
                            <div class="">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="nama_dosen" name="nama_dosen" class="form-control" value="<?= $nama_dosen ?>">
                                </div>
                            </div>
                            <div class="">
                                <div class="form-group">
