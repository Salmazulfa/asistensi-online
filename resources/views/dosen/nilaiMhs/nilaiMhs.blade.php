                        ...
                        <table id="default_order" class="table table-striped table-bordered display no-wrap"
                            ...
                            <?php $no=0; foreach($laporan as $row):$no++;?>
                                <tr>
                                    ...
                                    <td><?= $row->nilai; ?></td>
                                    <td>
                                        <button type="button" class="btn waves-effect waves-light btn-outline-info" onclick="window.location='/dosen/editNilai/{{ $row->id }}'"><span><i class="far fa-edit"></i></span> Edit </button>
                                    </td>
                                </tr>
                            <?php endforeach ?>
                        </table>
