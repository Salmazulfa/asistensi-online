        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ url('/admin/updateMhs') }}" method="POST">
                        @csrf
                        @method('POST')
                        <div class="form-body">
                            {{-- <div class="">
                            ...
                            <div class="">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="nama" name="nama" class="form-control" placeholder="Nama Praktikan" 
                                    value="<?= $mhs->nama ?>"
                                    >
                                </div>
                            </div>
                            ...
                            <div class="">
                                <div class="form-group">
                                    ...
                                    <?php
                                        if ($mhs->jenis_kelamin == "Perempuan") { ?>
                            ...
                            <div class="">
                                <form class="mt-3">
                                    <div class="form-group">
                                        <label>Alamat</label>
                                        <textarea class="form-control" rows="3" name="alamat" id="alamat"><?= $mhs->alamat ?></textarea>
                                    </div>
                                </form>
                            </div>
                            <div class="">
                                <div class="form-group">
                                    <label>Email</label>
                                    <input type="email" class="form-control" placeholder="abc@example.com" value="<?= $mhs->email ?>" id="email" name="email">
                                </div>
                            </div>
                            <div class="">
                                <div class="form-group">
                            ...
                            <div class="form-actions">
                                <div class="text-right">
                                    ...
                                    <button type="button" class="btn btn-dark" onclick="window.location='/admin/dataMhs/'">Kembali</button>
                                </div>
                            </div>
                        </div>
                        </div>
