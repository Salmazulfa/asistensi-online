...
<div class="container-fluid mt-5">
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <h6 class="card-subtitle">Dosen mengampu mata kuliah praktikum tertentu</h6>
                        ...
                        <table id="default_order" class="table table-striped table-bordered display no-wrap"
                            ...
                            <?php $no=0; foreach($dosen as $row):$no++; ?>
                                <tr>
                                    ...
                                    <td><?= $row->matkul->matkul; ?></td>
                                    <td>
                                        <button type="button" class="btn waves-effect waves-light btn-outline-info" onclick="window.location='/admin/editDosen/{{ $row->id }}'"><span><i class="far fa-edit"></i></span> Edit </button>
                                        <button type="button" class="btn waves-effect waves-light btn-outline-danger" data-toggle="modal"
                                        data-target="#hapusDosen" data-id="{{ $row->id }}"><span><i class="far fa-trash-alt"></i></span> Hapus </button>
                                    </td>
                                </tr>
                            <?php endforeach ?>
                            </tbody>
    ...
    <!-- Danger Alert Modal -->
    <div id="hapusDosen" class="modal fade" tabindex="-1" role="dialog"
    aria-hidden="true">
    <div class="modal-dialog modal-sm">
      <div class="modal-content modal-filled bg-danger">
        ...
        <div class="modal-footer">
          ...
          <form action="/admin/hapusDosen/{{ $row->id }}" method="POST">
            @csrf
            @method('DELETE')
