                    ...
                    <h3 class="card-title">Detail Materi</h3>
                        <div class="form-body">
                            ...
                            <div class="text-right">
                                ...
                                <button type="button" class="btn btn-dark" onclick="window.location='/mk/fr'">Kembali</button>
                            </div>
                        </div>
                </div>
            </div>
    ...
    <div class="row" id="kerjakan" style="display: none">
        <div class="col-sm-12">
            <div class="card">
                <div class="card-body">
                    @if ($json != "null") 
                    <form action="{{ url('/fr/laporan/update') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="form-body">
                            <div class="">
                                <div class="form-group">
                            ...
                            <div class="">
                                <div class="form-group">
                                    ...
                                    {{-- <label class="text-dark">{{ $tgl_upload }}</label>
                                    <label class="text-dark">{{ $materi->tgl_deadline }}</label> --}}
                                    @if ($tgl_upload > $materi->tgl_deadline)
                    ...
                    @else
                    <form action="{{ url('/fr/laporan/save') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="form-body">
                            <div class="">
                                <div class="form-group">
