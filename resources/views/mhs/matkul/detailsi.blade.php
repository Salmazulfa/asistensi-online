                    ...
                    <h3 class="card-title">Detail Materi</h3>
                        <div class="form-body">
                            ...
                            <div class="text-right">
                                ...
                                <button type="button" class="btn btn-dark" onclick="window.location='/mk/si'">Kembali</button>
                            </div>
                        </div>
                </div>
            </div>
    ...
    <div class="row" id="kerjakan" style="display: none">
        <div class="col-sm-12">
            <div class="card">
                <div class="card-body">
                    @if ($json != "null") 
                    <form action="{{ url('/si/laporan/update') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="form-body">
                            <div class="">
                                <div class="form-group">
                    ...
                    @else
                    <form action="{{ url('/si/laporan/save') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="form-body">
                            <div class="">
                                <div class="form-group">
