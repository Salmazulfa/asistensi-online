        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <button class="btn btn-rounded btn-primary mt-1 mb-2" onclick="window.location='/dosen/tambahMateri/'"><span><i class="fas fa-plus-circle"></i></span> Tambah Data </button>
                        ...
                        <table id="default_order" class="table table-striped table-bordered display no-wrap"
                            ...
                            <?php $no=0; foreach($materi as $row):$no++; ?>
                                <tr>
                                    ...
                                    <td><?= $row->materi; ?></td>
                                    <td>
                                        <button type="button" class="btn waves-effect waves-light btn-outline-info" onclick="window.location='/dosen/detailMateri/{{ $row->id }}'"><span><i class="fas fa-eye"></i></span> Detail </button>
